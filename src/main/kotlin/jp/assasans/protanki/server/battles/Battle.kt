...
class Battle(
  ...
  suspend fun showInfoFor(socket: UserSocket) {
    val user = socket.user ?: throw IllegalStateException("User must be logged in to see battle info.")
    val isSpectator = user.moderatorLevel >= ChatModeratorLevel.Moderator
